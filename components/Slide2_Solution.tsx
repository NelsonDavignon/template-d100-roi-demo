...
import { PhoneIcon, StopIcon } from '@heroicons/react/24/solid';
...
const Slide2_Solution: React.FC<SlideProps> = ({ config }) => {
  ...
  const handleStartDemo = async () => {
    ...
    try {
      ...
      // Pass the analyser to the visualizer
      const success = await serviceRef.current.start((audioAnalyser) => {
      ...
      setError("Connection failed. Refresh and try again.");
    }
  };
